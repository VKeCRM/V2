...
namespace VKeCRM.Common.Cryptography
{
    ...
    public static class Rijndael
    {
        ...
        public static string BytesToString(byte[] message)
        {
            ...
            //return encoderUnicode.GetString(message); //MTreat
            
            
            System.Text.ASCIIEncoding encoderASCII = new System.Text.ASCIIEncoding(); //MTreat

            return encoderASCII.GetString(message); //MTreat            
        }
        ...
        public static byte[] StringToBytes(string message)
        {
            ...
            //return encoderUnicode.GetBytes(message); //MTreat
            
            System.Text.ASCIIEncoding encoderASCII = new System.Text.ASCIIEncoding(); //MTreat

            return encoderASCII.GetBytes(message); //MTreat
