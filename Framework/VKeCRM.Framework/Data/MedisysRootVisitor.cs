...
namespace VKeCRM.Framework
{
	public class VKeCRMRootVisitor : NHibernateExpressionVisitor
	{
		...
		public VKeCRMRootVisitor(ICriteria rootCriteria, ISession session, bool isAtRoot)
		{
		...
		private void HandleSelectManyCall(MethodCallExpression call)
		{
			...
			if (call.Arguments.Count == 3)
			{
				...
				var visitor = new VKeCRMSelectManyVisitor(rootCriteria, alias);
