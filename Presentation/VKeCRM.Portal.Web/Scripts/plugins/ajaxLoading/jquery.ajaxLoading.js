...
function AjaxPage(p) {
    ...
    self.ExcuteInit = function () {
        ...
        vkecrm.manager.icon.executeLoadingReq = true;
...
plugin.AjaxLoading = {
        ...
        if ($this.currentPage != null) {
            ...
            if ($this.currentPage.key == key && (!$this.currentPage.MustRefresh)) {
                ...
                if (h) {
                    ...
                    try {
                        $this.currentPage.Js().BindDataToHtml();
                    } catch (e) {
    ...
    GetSinglePage: function (k, cb) {
        var studyId = page.global.GetQueryString('studyid');

        var data = { identity: k, param: studyId, random: Math.random() };
    ...
    Goto: function (key, h, cb) {
        ...
        var data = { identity: key, param: studyId, random: Math.random() };
